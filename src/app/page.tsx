          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
            <div className="flex flex-col justify-center space-y-6">
              ...
              <p className="max-w-[600px] text-muted-foreground md:text-xl">
                FinHub Central provides a comprehensive suite of tools for investors, clients, and administrators to manage financing deals with unparalleled efficiency and insight.
              </p>
